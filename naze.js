...
const nyoutube = ('ZrllXz © ZrllXz OFC 2023')  //ubah di config biar ngk emror
const foter = ('ZrllXz © ZrllXz OFC 2023')
...
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Sewa' }, type: 1 }]
            ...
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `6282139030290@s.whatsapp.net`
...
┃ *冬 My Love: Miraa><♡*
┃ *冬 Email: zril4seven@gmail.com@gmail.com*
